...
public class RecorridosResultado extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textHeader = (TextView) findViewById(R.id.header_titulo);
        textHeader.setText(String.format("Recorrido %s", servicio));
    ...
    {
        if (view.getId() == R.id.recorridos_back) {
